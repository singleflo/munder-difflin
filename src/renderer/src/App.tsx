    ...
    <div style={{
      ...
      >
        ...
        <button
          ...
          data-tip={appThemeNow === 'dark' ? t('app.themeLight') : t('app.themeDark')}
          ...
          {agent ? (
            ...
            <PixelPanel variant="default" noPadding style={{
              ...
              <div style={{
                ...
                color: 'var(--cth-ink-500)'
              }}>{t('app.wakingTitle')}</div>
              <p style={{ margin: 0, fontSize: 13, textAlign: 'center', color: 'var(--cth-ink-700)' }}>
                {/* godName passed explicitly: i18n's default is fed from the live
                    god agent, which does not exist yet while god is booting. */}
                {t('app.wakingLine1', { godName: bootingGodName })}<br />
                {t('app.wakingLine2')}
              </p>
            </PixelPanel>
          ) : (
            <PixelPanel variant="default" noPadding style={{
              ...
              <div style={{
                fontFamily: 'var(--cth-font-display)', fontSize: 10, lineHeight: '14px',
                color: 'var(--cth-ink-500)'
              }}>{t('app.noAgentTitle')}</div>
              <p style={{ margin: 0, fontSize: 13, textAlign: 'center', color: 'var(--cth-ink-700)' }}>
                {t('app.noAgentLine1')}<br />
                {t('app.noAgentLine2')}
              </p>
